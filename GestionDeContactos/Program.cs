...
namespace GestionDeContactos
{
            ...
            switch (input.Key)
                {
                    ...
                    default:
                    Console.Clear();
                    Console.WriteLine("POR FAVOR INGRESE UN NUMERO VALIDO ENTRE EL 1 y el 7.");
                    returnMainMenu();
                        break;
                }
    ...
    internal class ContactManager
    {
        ...
        public static void addContact()
        {
                ...
                if (string.IsNullOrEmpty(inputId) || string.IsNullOrEmpty(inputName) || string.IsNullOrEmpty(inputPhone) || string.IsNullOrEmpty(inputEmail))
                {
                Console.WriteLine("\nDEBE LLENAR TODOS LOS DATOS PARA CREAR UN CONTACTO NUEVO!");
